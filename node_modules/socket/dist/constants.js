...
// The Socket facts filename. The file itself is generated by the Coana CLI's
// `manifest` commands; this constant must match the filename Coana emits.
...
const LAZY_ENV = () => {
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_COANA_TECH_CLI_VERSION: envAsString("15.5.10"),
    ...
    INLINED_SOCKET_CLI_CYCLONEDX_CDXGEN_VERSION: envAsString("12.1.2"),
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString("1.1.128"),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.1.128:330612d:67b62e2f"),
...
exports.SCAN_TYPE_SOCKET = SCAN_TYPE_SOCKET;
exports.SCAN_TYPE_SOCKET_TIER1 = SCAN_TYPE_SOCKET_TIER1;
...
//# debugId=77f78c96-63d0-4e81-b5fd-a5ec7572047f
